package js.bs.goods.controller;
...
import js.bs.goods.service.GoodsService;
...
public class GoodsControllerImpl extends BaseController implements GoodsController {
	...
	@RequestMapping(value = "/categoryGoods*.do", method = RequestMethod.GET)
	public ModelAndView categoryGoods(
		...
		goodsList = goodsService.searchCategoryGoods(keyWord);
		ModelAndView mav = new ModelAndView(viewName);
		mav.addObject("goodsList", goodsList);
