...
import js.bs.order.service.OrderService;
...
public class OrderControllerImpl extends BaseController implements OrderController {
	...
	public ModelAndView orderEachGoods(
		...
		String[] email = memberInfo.getEmail2().split(",");
		String mail = memberInfo.getEmail1() + "@" + email[0];
	...
	public ModelAndView orderAllCartGoods(
		...
		for (int i = 0; i < cart_goods_qty.length; i++) {
			...
			System.out.println("cart_goods_qty[i].split(\":\") 이거 값 궁금한데 찍어보자:: " + cart_goods);
